<?php
/**
 * Part of the woobooking Framework Utilities Package
 *
 ...
 *
 * This class is adapted from the `FOFUtilsIp` class distributed with the woobooking! CMS as part of the FOF library by Akeeba Ltd.
