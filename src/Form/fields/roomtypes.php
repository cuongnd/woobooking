...
use WoobookingText;
if(!class_exists("WpBookingPro_FormFieldRoomtypes")) {
    /**
     ...
     * @since  1.7.0
     */
    class WpBookingPro_FormFieldRoomtypes extends FormField
    {
        /**
         * The form field type.
         *
         ...
         * @since  3.7
         */
        protected $layout = 'WooBooking.form.field.roomtypes';
