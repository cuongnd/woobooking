...
use WpBookingPro_Html;
use WoobookingText;
if(!class_exists("WpBookingPro_FormFieldAmenities")) {
    /**
     ...
     * @since  1.7.0
     */
    class WpBookingPro_FormFieldAmenities extends FormField
    {
        /**
         * The form field type.
         *
         ...
         * @since  3.7
         */
        protected $layout = 'WooBooking.form.field.amenities';
