...
use WpBookingPro_HtmlFrontend;
use WoobookingText;
if(!class_exists("WpBookingPro_FormFieldFilterprice")) {
    /**
     ...
     * @since  1.7.0
     */
    class WpBookingPro_FormFieldFilterprice extends FormField
    {
        /**
         * The form field type.
         *
         ...
         * @since  3.7
         */
        protected $layout = 'WooBooking.form.field.filterprice';
        ...
        public function setup(SimpleXMLElement $element, $value, $group = null)
        {
            ...
            if ($result == true) {
                ...
                if (!empty($inputmode)) {
                    $defaultInputmode = in_array('default',
                        $inputmode) ? WoobookingText::_('JLIB_FORM_INPUTMODE') . ' ' : '';
        ...
        protected function getOptions()
        {
            ...
            foreach ($this->element->children() as $option) {
                ...
                $options[] = WpBookingPro_HtmlFrontend::_(
                    'select.option', (string)$option['value'],
                    WoobookingText::alt(trim((string)$option), preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)),
                    'value', 'text'
                );
            }
            return $options;
