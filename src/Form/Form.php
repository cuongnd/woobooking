...
/**
 * Form Class for the woobooking Platform.
 *
...
class Form
{
	 ...
	 * the form control is set to 'woobooking' however, the fields would be rendered like:
	 * `<input name="woobooking[foo]" />` and `<input name="woobooking[bar]" />`.
	 *
