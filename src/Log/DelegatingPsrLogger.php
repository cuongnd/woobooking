...
class DelegatingPsrLogger extends AbstractLogger
{
	...
	/**
	 * Mapping array to map a PSR-3 level to a woobooking priority.
	 *
	 * @var    array
	 * @since  3.8.0
	 */
	...
	public function log($level, $message, array $context = array())
	{
		...
		// Map the level to woobooking's priority
		...
		// woobooking's logging API will only process a string or a LogEntry object, if $message is an object without __toString() we can't use it
