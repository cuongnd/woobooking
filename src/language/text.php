...
class WoobookingText
{
	 ...
	 *
	 * Examples:
	 * `<script>alert(woobooking.WoobookingText._('<?php echo WoobookingText::_("JDEFAULT", array("script"=>true)); ?>'));</script>`
	 ...
	 *
	 * Examples:
	 * `<script>alert(woobooking.WoobookingText._('<?php echo WoobookingText::plural("COM_PLUGINS_N_ITEMS_UNPUBLISHED", 1, array("script"=>true)); ?>'));</script>`
