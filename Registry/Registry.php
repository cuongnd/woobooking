<?php
/**
 * Part of the woobooking Framework Registry Package
 *
...
class Registry implements \JsonSerializable, \ArrayAccess, \IteratorAggregate, \Countable
{
	 ...
	 *
	 * @param   string  $path  Registry path (e.g. woobooking.content.showauthor)
	 *
	 * @return  boolean
	 *
	 * @since   1.0
	...
	public function set($path, $value, $separator = null)
	{
		 ...
		 * nodes that occur as a result of a double separator. ex: woobooking..test
	 ...
	 *
	 * @param   string  $path   Parent registry Path (e.g. woobooking.content.showauthor)
	 * @param   mixed   $value  Value of entry
	 *
	 * @return  mixed  The value of the that has been set.
	 *
	...
	public function append($path, $value)
	{
		...
		/*
		 * Explode the registry path into an array and remove empty
		 * nodes that occur as a result of a double dot. ex: woobooking..test
		 * Finally, re-key the array so they are sequential.
		 */
